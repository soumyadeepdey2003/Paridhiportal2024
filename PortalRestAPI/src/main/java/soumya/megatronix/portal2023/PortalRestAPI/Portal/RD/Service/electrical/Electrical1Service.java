...
public class Electrical1Service {
    ...
    public CompletableFuture<Electrical1> Electrical1Rd(Electrical1 member) {
        ...
        if ( gid1.isPresent() &&
            ...
            List<Electrical1> list = electrical.findAll();
    ...
    public Optional<Electrical1> findByGid(String gid) {
        Optional<Electrical1> gid1 = electrical.findByGid1(gid);
        Optional<Electrical1> gid2 = electrical.findByGid2(gid);
        Optional<Electrical1> gid3 = electrical.findByGid3(gid);
        Optional<Electrical1> gid4 = electrical.findByGid4(gid);
        Optional<Electrical1> gid5 = electrical.findByGid5(gid);
