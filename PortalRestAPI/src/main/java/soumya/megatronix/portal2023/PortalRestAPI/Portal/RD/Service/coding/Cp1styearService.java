...
public class Cp1styearService {
    ...
    public Optional<Cp1styearModel> findByGid(String gid) {
        Optional<Cp1styearModel> gid1 = coding.findByGid1(gid);
        Optional<Cp1styearModel> gid2 = coding.findByGid2(gid);
