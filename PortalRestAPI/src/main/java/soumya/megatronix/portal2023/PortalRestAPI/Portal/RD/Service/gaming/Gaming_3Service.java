...
public class Gaming_3Service {
    ...
    public Optional<Gaming_3> findByGid (String gid) {
        Optional<Gaming_3> gid1 = gaming.findByGid1(gid);
        Optional<Gaming_3> gid2 = gaming.findByGid2(gid);
        Optional<Gaming_3> gid3 = gaming.findByGid3(gid);
        Optional<Gaming_3> gid4 = gaming.findByGid4(gid);
        Optional<Gaming_3> gid5 = gaming.findByGid5(gid);
