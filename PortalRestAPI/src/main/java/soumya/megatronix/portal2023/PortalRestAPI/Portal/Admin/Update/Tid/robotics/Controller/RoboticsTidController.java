...
@RestController
@RequestMapping("/admin/updateTid/robotics")
public class RoboticsTidController {
    ...
    public CompletableFuture<ResponseEntity<?>> checkLineTrekkerTid (
        ...
        return CompletableFuture.completedFuture(service.checkLineTrekkerTid(tid, paid))
    ...
    public CompletableFuture<ResponseEntity<?>> checkRoboKlassikerTid(
        ...
        return CompletableFuture.completedFuture(service.checkRoboKlassikerTid(tid, paid))
                .thenApply(savedMember -> {
                    if (savedMember != null) {
                        return ResponseEntity.ok().body(savedMember);
                    } else {
    ...
    public CompletableFuture<ResponseEntity<?>> checkTriathlonTid (
        ...
        return CompletableFuture.completedFuture(service.checkTriathlonTid(tid, paid))
                .thenApply(savedMember -> {
                    if (savedMember != null) {
                        return ResponseEntity.ok().body(savedMember);
                    } else {
    ...
    public CompletableFuture<ResponseEntity<?>> checkWar8kgTid (
        ...
        return CompletableFuture.completedFuture(service.checkWar8kgTid(tid, paid))
                .thenApply(savedMember -> {
                    if (savedMember != null) {
                        return ResponseEntity.ok().body(savedMember);
                    } else {
    ...
    public CompletableFuture<ResponseEntity<?>> checkWar15KgTid (
        ...
        return CompletableFuture.completedFuture(service.checkWar15KgTid(tid, paid))
                .thenApply(savedMember -> {
                    if (savedMember != null) {
                        return ResponseEntity.ok().body(savedMember);
                    } else {
